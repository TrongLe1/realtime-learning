        ...
        <>
            <div className="bg-white p-3 push">
                <div className="d-lg-none">
                    <button type="button" className="btn w-100 btn-alt-secondary d-flex justify-content-between align-items-center" data-toggle="className-toggle" data-target="#horizontal-navigation-hover-normal" data-className="d-none">
                        Menu - Hover Normal
                ...
                <div id="horizontal-navigation-hover-normal" className="d-none d-lg-block mt-2 mt-lg-0">
                    <ul className="nav-main nav-main-horizontal nav-main-hover">
                        ...
                        <li className="nav-main-item">
                            <Link to={'/groupmanage'} className="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false">
                                <i className="si si-users fa-2x"></i>
                                <span className="nav-main-link-name">Groups</span>
                            </Link>
                        </li>
                        <li className="nav-main-item">
                            <a className="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false">
                                <i className="far fa-2x fa-circle-question"></i>
                                <span className="nav-main-link-name">Quiz</span>
                            </a>
                        </li>
                        <li className="nav-main-item">
                            <a className="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false">
                                <i className="fab fa-2x fa-slideshare"></i>
                                <span className="nav-main-link-name">Slides</span>
                            </a>
                        </li>
                        <li className="nav-main-item">
                            <Link to={'/memesgallery'} className="nav-main-link" data-toggle="submenu" aria-haspopup="true" aria-expanded="false">
                                <i className="si si-picture fa-2x"></i>
                        ...
                        <li className="nav-main-item ms-auto">
                            <a className="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false">
                                <i className="nav-main-link-icon far fa-user"></i>
