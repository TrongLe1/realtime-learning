                ...
                <div className="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
                    <div className="flex-grow-1 mb-1 mb-md-0">
                        ...
                        <h2 className="h6 fw-medium fw-medium text-muted mb-0">
                            Welcome <a className="fw-semibold">John</a>, everything looks great.
                        </h2>
                    </div>
                    <div className="mt-3 mt-md-0 ms-md-3 space-x-1">
                        <a className="btn btn-sm btn-alt-secondary space-x-1">
                            <i className="fa fa-cogs opacity-50"></i>
                            <span>Settings</span>
                        </a>
                        <div className="dropdown d-inline-block">
                            <button type="button" className="btn btn-sm btn-alt-secondary space-x-1" id="dropdown-analytics-overview" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i className="fa fa-fw fa-calendar-alt opacity-50"></i>
                                <span>All time</span>
                        ...
                        <div className="block block-rounded d-flex flex-column h-100 mb-0">
                            <div className="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                                <dl className="mb-0">
                                    ...
                                    <dd className="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Groups</dd>
                                </dl>
                        ...
                        <div className="block block-rounded d-flex flex-column h-100 mb-0">
                            <div className="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                                <dl className="mb-0">
                                    ...
                                    <dd className="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Slides</dd>
                                </dl>
                                <div className="item item-rounded-lg bg-body-light">
                        ...
                        <div className="block block-rounded d-flex flex-column h-100 mb-0">
                            <div className="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                                <dl className="mb-0">
                                    ...
                                    <dd className="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">New topic</dd>
                                </dl>
                                <div className="item item-rounded-lg bg-body-light">
                        ...
                        <div className="block block-rounded d-flex flex-column h-100 mb-0">
                            <div className="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                                <dl className="mb-0">
                                    ...
                                    <dd className="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">New quiz</dd>
                                </dl>
                                <div className="item item-rounded-lg bg-body-light">
