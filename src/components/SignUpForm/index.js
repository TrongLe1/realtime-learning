...
const SignUpSchema = yup.object().shape({
    ...
    password2: yup.string().required('*Re-enter your password').oneOf([yup.ref('password'), null], '*Your password does not match'),
});
        ...
        <div className="w-100">
            ...
            <div className="row g-0 justify-content-center">
                <div className="col-sm-8 col-xl-4">
                    <form className="js-validation-signup" onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-4">
                            <input type="text" className="form-control form-control-lg form-control-alt py-3"
                                   placeholder="Username"
                                   {...register("username")}
                            />
                            {errors.username && <p className="fs-sm fw-medium text-danger">{errors.username.message}</p>}
                        </div>
                        <div className="mb-4">
                            <input type="email" className="form-control form-control-lg form-control-alt py-3"
                                   placeholder="Email"
                                   {...register("email")}
                            />
                        ...
                        <div className="mb-4">
                            <input type="password" className="form-control form-control-lg form-control-alt py-3"
                        ...
                        <div className="mb-4">
                            <input type="password" className="form-control form-control-lg form-control-alt py-3"
                                   ...
                                   {...register("password2")}
                            />
                            {errors.password2 && <p className="fs-sm fw-medium text-danger">{errors.password2.message}</p>}
                        </div>
                        <div className="mb-4">
